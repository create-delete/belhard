...
public class Truck extends Car {
    ...
    private static final List<FuelType> possibleFuelTypes =
            Arrays.asList(FuelType.DIESEL);

    public Truck(String title, WheelType wheels, boolean wheelsOkState, FuelSystem fuelSystem) {
        super(title, WheelType.BIG, wheelsOkState, checkFuel(fuelSystem));
    }
